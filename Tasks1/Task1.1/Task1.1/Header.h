...
// Класс для генерации случайных паролей с разными уровнями сложностями.
class PasswordGenerator
{
public:
...
private:
    // FIX_ME: полe должно быть инициализировано при объявлении
    // FIX_ME: название поля должно быть информативным и начинаться с заглавной буквы
